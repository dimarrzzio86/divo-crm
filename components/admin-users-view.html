...
<link rel="stylesheet" href="/assets/dashboard.css?v=75">
<link rel="stylesheet" href="/assets/auth.css?v=75">
</head>
<body>
...
<script src="/components/components.js?v=75"></script>
<script>
function divoCheckAuthAndInit() {
  ...
  if (!user) {
    ...
    fetch('/components/auth-form.html?v=75')
